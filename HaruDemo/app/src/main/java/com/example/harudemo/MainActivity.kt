    ...
    private val onBottomNavItemSelectedListener = BottomNavigationView.OnNavigationItemSelectedListener {
        ...
        when(it.itemId){
            R.id.menu_home -> {
                ...
                if(snsFragment!=null) supportFragmentManager.beginTransaction().show(snsFragment!!).commit()
                if(calendarFragment!=null) supportFragmentManager.beginTransaction().hide(calendarFragment!!).commit()
                if(todoFragment!=null) supportFragmentManager.beginTransaction().hide(todoFragment!!).commit()
                if(statisticsFragment!=null) supportFragmentManager.beginTransaction().hide(statisticsFragment!!).commit()
                if(etcFragment!=null) supportFragmentManager.beginTransaction().hide(etcFragment!!).commit()
            }
            R.id.menu_calendar -> {
                ...
                if(snsFragment!=null) supportFragmentManager.beginTransaction().hide(snsFragment!!).commit()
                if(todoFragment!=null) supportFragmentManager.beginTransaction().hide(todoFragment!!).commit()
                if(statisticsFragment!=null) supportFragmentManager.beginTransaction().hide(statisticsFragment!!).commit()
                if(etcFragment!=null) supportFragmentManager.beginTransaction().hide(etcFragment!!).commit()
            }
            R.id.menu_todo->{
                ...
                if(todoFragment!=null) supportFragmentManager.beginTransaction().show(todoFragment!!).commit()
                if(snsFragment!=null) supportFragmentManager.beginTransaction().hide(snsFragment!!).commit()
                if(calendarFragment!=null) supportFragmentManager.beginTransaction().hide(calendarFragment!!).commit()
                if(statisticsFragment!=null) supportFragmentManager.beginTransaction().hide(statisticsFragment!!).commit()
                if(etcFragment!=null) supportFragmentManager.beginTransaction().hide(etcFragment!!).commit()
            ...
            R.id.menu_statistic -> {
                if(statisticsFragment == null){
                    ...
                    supportFragmentManager.beginTransaction().add(R.id.fragments_frame, statisticsFragment!!).commit()
                }
                if(statisticsFragment!=null) supportFragmentManager.beginTransaction().show(statisticsFragment!!).commit()
                if(snsFragment!=null) supportFragmentManager.beginTransaction().hide(snsFragment!!).commit()
                if(calendarFragment!=null) supportFragmentManager.beginTransaction().hide(calendarFragment!!).commit()
                if(todoFragment!=null) supportFragmentManager.beginTransaction().hide(todoFragment!!).commit()
                if(etcFragment!=null) supportFragmentManager.beginTransaction().hide(etcFragment!!).commit()
            ...
            R.id.menu_etc->{
                if(etcFragment == null){
                    ...
                    supportFragmentManager.beginTransaction().add(R.id.fragments_frame, etcFragment!!).commit()
                }
                if(etcFragment!=null) supportFragmentManager.beginTransaction().show(etcFragment!!).commit()
                if(snsFragment!=null) supportFragmentManager.beginTransaction().hide(snsFragment!!).commit()
                if(calendarFragment!=null) supportFragmentManager.beginTransaction().hide(calendarFragment!!).commit()
                if(todoFragment!=null) supportFragmentManager.beginTransaction().hide(todoFragment!!).commit()
                if(statisticsFragment!=null) supportFragmentManager.beginTransaction().hide(statisticsFragment!!).commit()
